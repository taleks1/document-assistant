...
const passwordSchema = z.object({
  currentPassword: z.string().min(8, "Лозинката мора да има најмалку 8 карактери"),
  newPassword: z.string().min(8, "Лозинката мора да има најмалку 8 карактери"),
  confirmPassword: z.string().min(8, "Лозинката мора да има најмалку 8 карактери"),
...
export default function ChangePasswordPage() {
  ...
  const onSubmit = async (values: PasswordFormValues) => {
    ...
    try {
      ...
      setTimeout(() => router.push("/citizen/profile"), 3000)
    } catch (err: any) {
