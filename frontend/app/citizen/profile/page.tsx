...
import { User, Save, CheckCircle, Loader2, Upload, Scan } from "lucide-react"
...
const profileSchema = z.object({
  ...
  embg: z.string().length(13, "ЕМБГ мора да има 13 цифри"),
  dateOfBirth: z.string().min(1, "Внесете датум на раѓање"),
})
          ...
          <Card className="border-none bg-transparent shadow-none">
            <CardHeader className="flex flex-row items-start justify-between gap-4">
              ...
              <div className="flex items-end gap-2">
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="w-full sm:w-auto justify-start rounded-xl"
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                {/* Датум на раѓање */}
                <div className="space-y-2">
                  <Label htmlFor="dateOfBirth">Датум на раѓање</Label>
                  <Input
                    id="dateOfBirth"
                    type="date"
                    disabled={!isEditing}
